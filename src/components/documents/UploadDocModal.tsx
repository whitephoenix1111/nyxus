...
//
// onSuccess tách khỏi onClose: toast chỉ fire khi addDocument thành công,
// không fire khi user đóng modal bằng X hoặc Huỷ.
'use client';
...
interface UploadDocModalProps {
  onClose: () => void;
  /** Gọi sau khi addDocument thành công — tách khỏi onClose để caller không toast khi chỉ thoát. */
  onSuccess?: () => void;
...
export default function UploadDocModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Toast nằm ở đây — chắc chắn chỉ fire khi lưu thành công
